...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='cruise',
                        help='The kind of domain for training cruise data, default: person')
    ...
    parser.add_argument('--feature-channel', type=int, default=32,
                        help='The number of Feature map channels. Default: 32')
